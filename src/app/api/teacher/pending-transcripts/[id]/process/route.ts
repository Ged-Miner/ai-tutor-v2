...
export async function POST(
  ...
  try {
    ...
    // Create the lesson with raw transcript (summary will be generated in background)
    const lesson = await prisma.lesson.create({
      data: {
        title: customTitle || pendingTranscript.lessonTitle,
        rawTranscript: pendingTranscript.rawTranscript,
        summary: null, // Will be generated by OpenAI in Phase 5
        lessonCode,
        position,
        courseId,
      },
    ...
    return NextResponse.json({
      success: true,
      message: 'Lesson created successfully. Summary will be generated shortly.',
      lesson: {
        id: lesson.id,
        title: lesson.title,
